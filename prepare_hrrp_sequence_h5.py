...
output_dir = r'D:\HRRP\A02\SupConLearning\h5_car2_seq'
...
# IMPORTANT:
# Use a list of tuples instead of a dict, so duplicate keys do not get overwritten silently.
# The original script had a duplicated class key/file name ('Mitsubishi'), which is dangerous.
# Keep this list consistent with your real dataset.
file_specs: List[Tuple[str, int]] = [
    ...
    ('MazdaMPV_el30.0000.mat', 6),
    # If you really have another class here, replace the duplicated filename below
    # with the correct .mat file name instead of reusing Mitsubishi.
    ('Mitsubishi_el30.0000.mat', 7),
